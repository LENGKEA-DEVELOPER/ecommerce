...
<div class="container pt-2">
                             ...
                             <a href="{{route('product.brand_phone',"huawei")}}"> <img src="img/huawei.jpg" alt=""></a>
                                        ...
                                        <div class=" imgbrands ">
                                         <a href="{{route('product.brand_phone',"oneplus")}}"> <img src="img/oneplus.jpg" alt=""></a>
                                            ...
                                            <div class=" imgbrands ">
                                             <a href="{{route('product.brand_phone',"oppo")}}"> <img src="img/oppo.jpg" alt=""></a>
                                                </div>
    ...
    <div class="row">
        ...
        @foreach ($phone_acticle as $item=>$val)
...
<div class="col-12 pt-5" style="align-items: center;justify-content: center;display: flex;"> {{$phone_acticle->links()}}</div>
@include('footer')
@endsection
